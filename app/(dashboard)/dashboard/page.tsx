      ...
      case 'BUSINESS':
        return {
          ...
          stats: [
            ...
            { title: 'Average Rating', value: '4.8', icon: 'trending-up', trend: { value: 5, label: 'vs last month' } },
            { title: 'Profile Views', value: '2.3K', icon: 'users', trend: { value: 23, label: 'vs last month' } },
            { title: 'Response Rate', value: '98%', icon: 'file' },
          ],
          actions: [
            { label: 'Manage Business', href: '/dashboard/business', icon: 'building' },
            { label: 'View Reviews', href: '/dashboard/business/reviews', icon: 'star' },
            { label: 'Get Widgets', href: '/dashboard/business/widgets', icon: 'file' },
          ],
        }
      case 'RESELLER':
        return {
          ...
          stats: [
            { title: 'Total Commissions', value: '$4,250', icon: 'trending-up', trend: { value: 15, label: 'vs last month' } },
            { title: 'Active Clients', value: '23', icon: 'users', trend: { value: 8, label: 'vs last month' } },
            { title: 'Pending Payout', value: '$650', icon: 'file' },
            { title: 'Conversion Rate', value: '12%', icon: 'trending-up' },
          ],
          actions: [
            { label: 'View Commissions', href: '/dashboard/reseller/commissions', icon: 'trending-up' },
      ...
      case 'SUPPORT':
        return {
          ...
          stats: [
            ...
            { title: 'Total Businesses', value: '3,456', icon: 'building', trend: { value: 8, label: 'vs last month' } },
            { title: 'Pending Reviews', value: '42', icon: 'star', trend: { value: -20, label: 'vs last week' } },
            { title: 'Open Tickets', value: '15', icon: 'file' },
          ],
          actions: [
            { label: 'Manage Users', href: '/dashboard/admin/users', icon: 'users' },
            { label: 'Manage Businesses', href: '/dashboard/admin/businesses', icon: 'building' },
      ...
      default:
        return {
          ...
          stats: [
            ...
            { title: 'Helpful Votes', value: '45', icon: 'trending-up' },
            ...
            <CardContent>
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                {content.actions.map((action) => {
                  const Icon = actionIconMap[action.icon as keyof typeof actionIconMap]
                  return (
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  ...
                  { title: 'Profile updated', time: '1 day ago', icon: 'building' },
